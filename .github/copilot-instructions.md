...
| **skill-evolver** | `.github/skills/skill-evolver/SKILL.md` | "improve/evolve skills", "run a skill retrospective", "what went wrong with X skill", "why didn't skill Y trigger", "review skill friction", "that didn't go well" |
