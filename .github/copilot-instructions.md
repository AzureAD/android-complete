...
| **vuln-triage-reporter** | `.github/skills/vuln-triage-reporter/SKILL.md` | `[MSRC]`/`[ITD]` vulnerability triage, classify/right-size severity, FireWatch findings, on-call security report |
