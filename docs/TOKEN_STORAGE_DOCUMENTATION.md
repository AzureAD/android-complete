...
**Note**: FOCI stands for "Family of Client IDs" - a Microsoft feature that allows first-party applications in the same "family" to share refresh tokens
...
**Example**:
```
a1b2c3d4-e5f6-7890-abcd-ef1234567890.12345678-9abc-def0-1234-56789abcdef0
  -login.microsoftonline.com
  -12345678-9abc-def0-1234-56789abcdef0
```
(Shown on multiple lines for readability; actual key is a single string without line breaks)
...
- **BaseController**: `common/common4j/src/main/com/microsoft/identity/common/java/controllers/BaseController.java`
  - `saveTokens()` method (approx. line 903 - may vary with code changes)

#### Cache Implementation
- **MsalOAuth2TokenCache**: `common/common4j/src/main/com/microsoft/identity/common/java/cache/MsalOAuth2TokenCache.java`
  - `saveAndLoadAggregatedAccountData()` (approx. line 521)
  - `save()` methods (approx. lines 206, 258)
  - `saveAccounts()` (approx. line 1658)
  - `saveCredentialsInternal()` (approx. line 1664)
...
- **SharedPreferencesAccountCredentialCache**: `common/common4j/src/main/com/microsoft/identity/common/java/cache/SharedPreferencesAccountCredentialCache.java`
  - `saveAccount()` (approx. line 102)
  - `saveCredential()` (approx. line 120)

- **CacheKeyValueDelegate**: `common/common4j/src/main/com/microsoft/identity/common/java/cache/CacheKeyValueDelegate.java`
  - `generateCacheKey()` for accounts (approx. line 102)
  - `generateCacheKey()` for credentials (approx. line 142)
  - `generateCacheValue()` (approx. lines 134, 212)
...
- **SharedPreferencesFileManager**: `common/common/src/main/java/com/microsoft/identity/common/internal/cache/SharedPreferencesFileManager.java`
  - `putString()` with encryption (approx. line 136)
  - `getString()` with decryption (approx. line 177)
