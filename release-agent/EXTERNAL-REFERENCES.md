...
| ADO build def **397224** | Android Build Release (org msazure / project One) | readiness `build_access`, Phase-5 `signoff_start` | az | Phase 5 locates the matching release-branch run (or future AndroidBuildBroker1ES resource-linked run) and starts the `Release Sign Off` stage; definition page: https://msazure.visualstudio.com/One/_build?definitionId=397224 |
